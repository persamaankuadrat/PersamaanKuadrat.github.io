function myFunction() {
  ...
  if (jawaban1=="" && jawaban2=="") {
    ...
    if (jawaban1=="5" && jawaban2=="3") {
    document.getElementById("demo").innerHTML = "<b style='color: green'>Jawabanmu Benar</b>, <br><br><b> Pembahasan Penyelesaian Persamaan Kuadrat dengan Cara Faktorisasi:</b><br><br>\\[x^{2} - 8x + 15 = 0\\] <br><br>\\[\\Leftrightarrow \\left ( x - 3 \\right ) \\left ( x - 5 \\right ) = 0\\]<br><br>\\[\\Leftrightarrow x - 3 = 0\\]&emsp; atau &emsp;\\[ x - 5 = 0\\]<br><br>\\[\\Leftrightarrow x = 3\\] &emsp;atau&emsp; \\[x = 5\\]  ";
    MathJax.typeset();
    } else if (jawaban1!="" && jawaban2!="") {
      if (jawaban1=="3" && jawaban2=="5") {
      document.getElementById("demo").innerHTML = "<b style='color: green'>Jawabanmu Benar</b>, <br><br><b> Pembahasan Penyelesaian Persamaan Kuadrat dengan Cara Faktorisasi:</b><br><br>\\[x^{2} - 8x + 15 = 0\\] <br><br>\\[\\Leftrightarrow \\left ( x - 3 \\right ) \\left ( x - 5 \\right ) = 0\\]<br><br>\\[\\Leftrightarrow x - 3 = 0\\]&emsp; atau &emsp;\\[ x - 5 = 0\\]<br><br>\\[\\Leftrightarrow x = 3\\]&emsp; atau &emsp;\\[x = 5\\]";
      MathJax.typeset();
      }
    else {
