...
function cek111(){
  ...
  function cekjawaban3(){
    ...
    if(form.jawaban.value=='C' || form.jawaban.value=='c'){
      document.getElementById("tampil").innerHTML="<b style='color: green'>Selamat! jawabanmu benar ^-^ </b><br> Variabel dari persamaan kuadrat \\[p^{2} + 2p - 8 = 0\\] adalah \\[p^{2} , p\\]";
    ...
    if(form.jawaban2.value=='B' || form.jawaban2.value=='b'){
      document.getElementById("tampil2").innerHTML="<b style='color: green'>Selamat! jawabanmu benar ^-^ </b><br> Koefisien dari persamaan kuadrat \\[p^{2} + 2p - 8 = 0\\] adalah \\[1 , 2\\]";
      // document.getElementById("tampil2").style.color = "green";
      }else{
    ...
    if(form.jawaban3.value=='C' || form.jawaban3.value=='c'){
      document.getElementById("tampil3").innerHTML="<b style='color: green'>Selamat! jawabanmu benar ^-^ </b><br> Konstanta dari persamaan kuadrat \\[p^{2} + 2p - 8 = 0\\] adalah \\[-8\\]";
      }else{
