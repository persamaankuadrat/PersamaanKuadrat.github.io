...
function cek1(){
  ...
  document.getElementById("tampil").innerHTML="<b style='color: green'>Jawabanmu Benar ^_^</b> <br><br> Dikarenakan \\[D < 0\\], maka persamaan kuadrat tidak mempunyai akar real. <br><br> \\[D = b^{2} - 4ac\\] <br><br> \\[D = \\left ( 2 \\right )^{2} - \\left ( 4\\cdot 1\\cdot 4 \\right )\\] <br><br> \\[D = 4 - 16 )\\] <br><br> \\[D = - 12\\] <br><br> Sehingga, \\[D < 0\\]";
  MathJax.typeset();
  }else{
