...
function checkbenar() {
  console.log("benar");
  document.getElementById("jawaban").innerHTML="<b style='color: green'>Jawabanmu Benar ^_^</b> <br><br> Dikarenakan \\[D > 0\\], maka persamaan kuadrat mempunyai 2 akar real berbeda. <br><br> \\[D = b^{2} - 4ac\\] <br><br> \\[D = \\left ( 12 \\right )^{2} - \\left ( 4 \\cdot (-4) \\cdot (-5) \\right )\\] <br><br> \\[D = 144 - 80 \\] <br><br> \\[D  = 64\\] <br><br> Sehingga, \\[D > 0\\]";
  MathJax.typeset();
}
