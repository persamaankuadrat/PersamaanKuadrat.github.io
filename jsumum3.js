...
function cek111(){
  ...
  function cekjawaban3(){
    ...
    if(form.jawaban.value=='A' || form.jawaban.value=='a'){
      document.getElementById("tampil").innerHTML="<b style='color: green'>Selamat! jawabanmu benar ^-^ </b><br> Variabel dari persamaan kuadrat \\[-x^{2} - 2x + 1 = 0\\]  adalah \\[x^{2} , x\\]";
    ...
    if(form.jawaban2.value=='C' || form.jawaban2.value=='c'){
      document.getElementById("tampil2").innerHTML="<b style='color: green'>Selamat! jawabanmu benar ^-^ </b><br> Koefisien dari persamaan kuadrat \\[-x^{2} - 2x + 1 = 0\\] adalah \\[-1 , -2\\]";
      // document.getElementById("tampil2").style.color = "green";
      }else{
    ...
    if(form.jawaban3.value=='B' || form.jawaban3.value=='b'){
      document.getElementById("tampil3").innerHTML="<b style='color: green'>Selamat! jawabanmu benar ^-^ </b><br> Konstanta dari persamaan kuadrat \\[-x^{2} - 2x + 1 = 0\\] adalah \\[1\\]";
      }else{
