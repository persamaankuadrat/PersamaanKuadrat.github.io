...
function cek111(){
  ...
  function cekjawaban3(){
    ...
    if(form.jawaban.value=='B' || form.jawaban.value=='b'){
      document.getElementById("tampil").innerHTML="<b style='color: green'>Selamat! jawabanmu benar ^-^ </b><br> Variabel dari persamaan kuadrat \\[3y^{2} - 7 + y = 0\\] adalah \\[y^{2} , y\\]";
    ...
    if(form.jawaban2.value=='A' || form.jawaban2.value=='a'){
      document.getElementById("tampil2").innerHTML="<b style='color: green'>Selamat! jawabanmu benar ^-^ </b><br> Koefisien dari persamaan kuadrat \\[3y^{2} - 7 + y = 0\\] adalah \\[3 , 1\\]";
      // document.getElementById("tampil2").style.color = "green";
      }else{
    ...
    if(form.jawaban3.value=='C' || form.jawaban3.value=='c'){
      document.getElementById("tampil3").innerHTML="<b style='color: green'>Selamat! jawabanmu benar ^-^ </b><br> Konstanta dari persamaan kuadrat \\[3y^{2} - 7 + y = 0\\] adalah \\[-7\\]";
      }else{
