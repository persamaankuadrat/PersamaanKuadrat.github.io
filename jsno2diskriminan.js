...
function checkbenar() {
  console.log("benar");
  document.getElementById("jawaban").innerHTML="<b style='color: green'>Jawabanmu Benar ^_^</b> <br><br> Dikarenakan \\[D = 0\\], maka persamaan kuadrat mempunyai 1 akar real yang sama (kembar). <br><br> \\[D = b^{2} - 4ac\\] <br><br> \\[D = \\left ( 12 \\right )^{2} - \\left ( 4 \\cdot 4 \\cdot (9) \\right )\\] <br><br> \\[D = 144 - 144 = 0\\]  <br><br> Sehingga, \\[D = 0\\]";
  MathJax.typeset();
}
