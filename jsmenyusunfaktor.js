...
for (let i=0; i<jawaban.length; i++){
  ...
  jawaban[i].addEventListener('keyup', function(){
    ...
    if (i==18){
      ...
      if(jawaban[18].value.length==2){

        if(jawaban[18].value==12){
          //boxwarna
