function myFunction() {
  ...
  if (jawaban1=="" && jawaban2=="") {
    ...
    MathJax.typeset();
      ...
      document.getElementById("demo").innerHTML = "<b style='color: red'>Jawabanmu Salah</b>, <br><b>Ingat!!</b> <br><br> Langkah-langkah menyelesaikan persamaan kuadrat dengan cara melengkapkan kuadrat sempurna yakni : <br><br> 1. Jika ditemukan koefisien \\[x^{2}\\] tidak sama dengan satu seperti persamaan \\[2x^{2} - 2x - 12 = 0\\], maka persamaan kuadrat tersebut harus dibagi dua agar \\[x^{2}\\] menjadi sama dengan satu, seperti berikut : <br> \\[\\Leftrightarrow 4x^{2} - 20x - 56 = 0 \\] <br><br> \\[\\Leftrightarrow \\frac{4x^{2} - 20x - 56 = 0}{4}\\]<br> <br> \\[\\Leftrightarrow x^{2} - 5x - 14 = 0\\]<br><br> 2. Langkah selanjutnya sama dengan yang sebelumnya yakni tempatkan suku-suku yang mengandung variabel di ruas kiri dan konstanta di ruas kanan <br><br> 3. Koefisien \\[x^{2}\\] harus sama dengan satu. <br><br> 4. Tambahkan kedua ruas dengan kuadrat dari setengah koefisien \\[x\\] atau \\[+ \\left ( \\frac{...}{2} \\right )^{2}\\] pada koefisien \\[x\\], sehingga ruas kiri menjadi kuadrat sempurna. <br><br> 5. Kemudian setelah kuadrat berubah menjadi akar pada ruas kanan, tambahkan \\[\\pm \\]. ";
      MathJax.typeset();
    }
  } }
   }