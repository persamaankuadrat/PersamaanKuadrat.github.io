...
function cek1(){
  ...
  document.getElementById("tampil").innerHTML="<b style='color: green'>Jawabanmu Benar ^_^</b> <br><br> Dikarenakan \\[D > 0\\], maka persamaan kuadrat mempunyai 2 akar real berbeda. <br><br> \\[D = b^{2} - 4ac\\] <br><br> \\[D = \\left ( 1 \\right )^{2} - \\left ( 4\\cdot 2\\cdot (-3) \\right )\\] <br><br> \\[D = 1 - \\left ( - 24 \\right )\\] <br><br> \\[D = 1 + 24 = 25\\] <br><br> Sehingga, \\[D > 0\\]";
  MathJax.typeset();
  }else{
