    ...
    function myFunction1() {
        var x = document.getElementById("myText1").value.split(' ').join('');
           var jawaban;
           if (x == "6") {
             jawaban = "<b style='color: green'>Jawabanmu Benar</b> <br><br> <b> Pembahasan: </b> <br><br> Dikarenakan rumus dari : \\[\\frac{1}{x_{1}} + \\frac{1}{x_{2}} \\] maka, <br><br> \\[\\frac{1}{x_{1}} + \\frac{1}{x_{2}} = \\frac{x_{1} + x_{2}}{x_{1} \\cdot x_{2}} = \\frac{18}{3} = 6\\]";
           } else if (x =="") {
