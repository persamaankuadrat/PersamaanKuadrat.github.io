...
function kkmSuccess(items1) {
    ...
    kkmK3.value = kkm3;
    const kkmKuis4 = document.querySelector('.kkmKuis4');
    kkmKuis4.innerHTML = kkm4;
...
function setKKM5() {
    let KKM5 = document.getElementById('KKM5').value;
    var task = {
        id: 4,
        kkm: KKM5
        }
        let database = firebase.database().ref("db_kkm/" + 4);
        database.set(task);
}