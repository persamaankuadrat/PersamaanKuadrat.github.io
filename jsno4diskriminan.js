...
function checkbenar() {
  console.log("benar");
  document.getElementById("jawaban").innerHTML="<b style='color: green'>Jawabanmu Benar ^_^</b> <br><br> Dikarenakan \\[D < 0\\], maka persamaan kuadrat tidak mempunyai akar real. <br><br> \\[D = b^{2} - 4ac\\] <br><br> \\[D = \\left ( 10 \\right )^{2} - \\left ( 4\\cdot 4\\cdot 11 \\right )\\] <br><br> \\[D = 100 - 176 )\\] <br><br> \\[D = - 76\\] <br><br> Sehingga, \\[D < 0\\]";
  MathJax.typeset();
}
