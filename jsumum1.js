...
function cek111(){
  ...
  function cekjawaban3(){
    ...
    if(form.jawaban.value=='A' || form.jawaban.value=='a'){
      document.getElementById("tampil").innerHTML="<b style='color: green'>Selamat! jawabanmu benar ^-^ </b><br> Variabel dari persamaan kuadrat \\[2x^{2} + 3x -2 = 0\\] adalah \\[x^{2} , x\\]";
    ...
    if(form.jawaban2.value=='B' || form.jawaban2.value=='b'){
      document.getElementById("tampil2").innerHTML="<b style='color: green'>Selamat! jawabanmu benar ^-^ </b><br> Koefisien dari persamaan kuadrat \\[2x^{2} + 3x -2 = 0\\] adalah \\[2 , 3\\]";
      // document.getElementById("tampil2").style.color = "green";
      }else{
    ...
    if(form.jawaban3.value=='C' || form.jawaban3.value=='c'){
      document.getElementById("tampil3").innerHTML="<b style='color: green'>Selamat! jawabanmu benar ^-^ </b><br> Konstanta dari persamaan kuadrat \\[2x^{2} + 3x -2 = 0\\] adalah \\[-2\\]";
      }else{
